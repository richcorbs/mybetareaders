...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { active: @coupon.active, amount: @coupon.amount, code: @coupon.code, percent: @coupon.percent }
    end
  ...
  test "should update coupon" do
    put :update, id: @coupon, coupon: { active: @coupon.active, amount: @coupon.amount, code: @coupon.code, percent: @coupon.percent }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
